...
# import notebook_v0 as notebook
import notebook_v0 as notebook

class Question1(unittest.TestCase):
    def test_load_ipynb_minimal(self):
        ipynb = notebook.load_ipynb("samples/minimal.ipynb")
        self.assertEqual(
            {
                "cells": [],
                "metadata": {},
    ...
    def test_load_ipynb_hello_world(self):
        ipynb = notebook.load_ipynb("samples/hello-world.ipynb")
        self.assertEqual(
            {
                "cells": [
                    {
    ...
    def test_save_ipynb_minimal(self):
        ...
        notebook.save_ipynb(ipynb, "samples/minimal-save-load.ipynb")
        try:
            ipynb_saved = notebook.load_ipynb("samples/minimal-save-load.ipynb")
    ...
    def test_save_ipynb_hello_world(self):
        ipynb = notebook.load_ipynb("samples/hello-world.ipynb")
        self.assertIsNotNone(ipynb)
        notebook.save_ipynb(ipynb, "samples/hello-world-save-load.ipynb")
        try:
            ipynb_saved = notebook.load_ipynb("samples/hello-world-save-load.ipynb")
            self.assertIsNotNone(ipynb_saved)
            self.assertEqual(ipynb, ipynb_saved)
        finally:
...
class Question2(unittest.TestCase):
    def test_get_format_version_minimal(self):
        ipynb = notebook.load_ipynb("samples/minimal.ipynb")
        self.assertEqual("4.5", notebook.get_format_version(ipynb))
    ...
    def test_get_metadata(self):
        ipynb = notebook.load_ipynb("samples/metadata.ipynb")
        self.assertEqual(
            {
            ...
            notebook.get_metadata(ipynb),
        )

    def test_get_cells_minimal(self):
        ipynb = notebook.load_ipynb("samples/minimal.ipynb")
        self.assertEqual([], notebook.get_cells(ipynb))
...
# Goodbye! 👋
""",
            notebook.to_percent(ipynb),
        )

    def test_to_starboard_text(self):
        ipynb = notebook.load_ipynb("samples/hello-world.ipynb")
        with open("output.txt", "w") as f:
            f.write(notebook.to_starboard(ipynb))
        self.assertEqual(
            r"""# %% [markdown]
Hello world!
============
...
""",
            notebook.to_starboard(ipynb, html=True),
        )

class Question5(unittest.TestCase):
    def test_clear_output(self):
        ipynb = notebook.load_ipynb("samples/hello-world.ipynb")
        notebook.clear_outputs(ipynb)
        self.assertEqual(
            {
                "cells": [
                    {
        ...
        for cell in notebook.get_cells(ipynb):
...
class Question6(unittest.TestCase):
    def test_get_streams(self):
        ipynb = notebook.load_ipynb("samples/streams.ipynb")
        self.assertEqual("👋 Hello world! 🌍\n", notebook.get_stream(ipynb))
        self.assertEqual(
            "🔥 This is fine. 🔥 (https://gunshowcomic.com/648)\n",
            notebook.get_stream(ipynb, stdout=False, stderr=True),
        )
        self.assertEqual(
            r"""👋 Hello world! 🌍
🔥 This is fine. 🔥 (https://gunshowcomic.com/648)
""",
            notebook.get_stream(ipynb, stdout=True, stderr=True),
        )

class Question7(unittest.TestCase):
    def test_exceptions_hello_world(self):
        ipynb = notebook.load_ipynb("samples/hello-world.ipynb")
        self.assertEqual([], notebook.get_exceptions(ipynb))

    def test_exceptions_errors(self):
        ipynb = notebook.load_ipynb("samples/errors.ipynb")
        errors = notebook.get_exceptions(ipynb)
...
class Question8(unittest.TestCase):
    def test_get_images(self):
        ipynb = notebook.load_ipynb("samples/images.ipynb")
        images = notebook.get_images(ipynb)
